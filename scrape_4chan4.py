...
engine= sqlalchemy.create_engine('mysql+pymysql://root:frismeister@localhost:3306/fourchan2')
...
def startpoint():
    ...
    try:
        #sql connection
        engine= sqlalchemy.create_engine('mysql+pymysql://root:frismeister@localhost:3306/fourchan2')
        active_threads.to_sql(name='actives',
        con=engine,
        index=False,
        if_exists='replace')
...
#for i in list(activesno):
    #threadcrawler(i)
#print("start point scraped -- pausing for 3 minutes")
#sleep(180)
batchid=1
while 1 > 0:
    ...
    sleep(10)
    protocol()
    print(" #### batch nr " + str(batchid) + " scraped! Pausing for 3 minutes ####")
    sleep(180)
    batchid=batchid+1
